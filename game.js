  ...
  if (document.getElementById("gameArea")) {
    ...
    function playClickSound() {
      ...
      if (sound) {
        ...
        sound
          .play()
          .catch((e) => console.error("Erro ao tocar o som do clique:", e));
      }
    }
    ...
    function startGame() {
      ...
      clickSoundPool[0]
        ...
        .then(() => {
          ...
          backgroundMusic
            .play()
            .catch((e) => console.error("Erro ao tocar a música de fundo:", e));
        })
        .catch((e) =>
          console.error("O som do clique não pôde ser pré-carregado.")
        );
      incrementTotalGames();
      loadGameData();
      updateDisplay();
    ...
    function levelUp() {
      ...
      gameInterval = setInterval(createGameItem, speed);
      alert(
        `Parabéns! Você alcançou o Nível ${level}! A velocidade irá aumentar.`
      );
    }
