document.addEventListener("DOMContentLoaded", () => {
    if (document.getElementById("gameArea")) {
        ...
        function resetGame() {
            ...
            // Salva a sessão do jogo antes de redefinir tudo
            saveGameSession();
        ...
        function saveGameSession() {
            if (score > 0) {
                ...
                const durationInSeconds = Math.floor((gameEndTime - gameStartTime) / 1000);
                const durationString = new Date(durationInSeconds * 1000).toISOString().substr(11, 8);
                ...
                localStorage.setItem("senacDash_gamesHistory", JSON.stringify(gamesHistory));
            }
        }
